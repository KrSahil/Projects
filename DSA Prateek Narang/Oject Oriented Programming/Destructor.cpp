...
//setter for name
    ...
    //here, in this class only name has dynamically allocated memory so we need destructor for name

    /*
    ~Product(){
        cout<<"Deleting Product"<<name<<endl;
    }
    */ //but this is not  a good approach as it doesnt prevent memory leak
    ...
    ~Product(){
        ...
        if (name!=NULL){
            delete[] name;
            name = NULL;
        } //this piece of code prevents memory leak
    }
